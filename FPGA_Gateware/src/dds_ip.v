...
// Retrieval info:  <NETLIST_SECTION active_core="dds_ip_st" >
...
// Retrieval info:      <PRIVATE name = "APRI" value="11"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="dds_ip_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="dds_ip_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RAW" value="8"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RDW" value="13"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNW" value="256"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAX" value="3328"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSF" value="dds_ip_sin.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSV" value="dds_ip_sin.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSH" value="dds_ip_sin.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCF" value="dds_ip_cos.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCV" value="dds_ip_cos.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCH" value="dds_ip_cos.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="292"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="6656"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "PHI_INC" value="85899346"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen_enable">
// Retrieval info:      <PRIVATE name = "language" value="Verilog HDL"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen">
// Retrieval info:      <PRIVATE name = "filename" value="dds_ip.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="dds_ip_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="EP4CE15F17C8L"  type="STRING"  enable="1" />
