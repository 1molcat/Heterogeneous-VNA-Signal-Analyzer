...
% file : dds_ip_tb.m
%
% Description : The following Matlab testbench excercises the NCO model dds_ip_model.m
...
[sin_out,cos_out] = dds_ip_model(phi_inc_i,phase_mod_i,freq_mod_i);
fid_s = fopen('fsin_o_dds_ip_matlab.txt','w');
for i=1:N
  fprintf(fid_s,'%f\n',sin_out(i));
end
